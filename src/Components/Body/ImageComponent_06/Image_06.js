...
import classes from './Image_06.module.css';
  ...
  return (
    <div className={classes.main_container}>
      <ul className={classes.ul_image}>
        ...
        <li className={classes.li_image}>
          <Link to="/">
            <img src={frst_image} alt="NASA" className={classes['thrd-image01']} />
        ...
        <li className={classes.li_image01}>
          <Link to="/">
            <img src={scnd_image} alt="NASA" className={classes['frth-image01']} />
